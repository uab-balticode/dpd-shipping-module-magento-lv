...
/**
 * <p>Handles the AJAX request defined for the frontend (from database table balticode_livehandler)</p>
 ...
 * @author matishalmann
 */
class Balticode_Livehandler_IndexController extends Mage_Core_Controller_Front_Action {
