...
$installer->run("
    ...
    INSERT INTO {$this->getTable('balticode_postoffice')} 
    ...
    VALUES 
    ((SELECT id from {$this->getTable('balticode_carriermodule')} WHERE carrier_code = 'balticodedpdltflat'), 'balticodedpdltflat', '1' , 'Tarne kulleriga koju', '', '', '', '', '', NOW(), NOW());
